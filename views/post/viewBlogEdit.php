    ...
    <div class="p-3">
        ...
        <form action="/Post/BlogEdit<?= "/".$mapView["UrlForm"] ?>" method="post" enctype="multipart/form-data">
            ...
            <label class="bg-body-tertiary round background">
                <input name="Title" type="text" class="form-control custom-input round inputBackground input" placeholder="Entrez votre titre" value="<?php echo $mapView["Title"]?>">
            </label>
            ...
            <label for="file" class="btn btn bg-body-tertiary round background" id="chooseFileLabel">Entrez votre miniature
                ...
                <img src="<?= ($mapView["Img"] != null) ? $mapView["Img"] : "../../media/public_assets/icone/iconeBlogUploadImg.png" ?>" width="260" height="300" alt="logo pour l'upload d'image">
            </label>

            <!-- Texte -->
            <label class="bg-body-tertiary round background textInput">
                <textarea name="Content" class="form-control custom-input round inputBackground input" placeholder="Entrez le contenu"><?php echo $mapView["Content"]?></textarea>
            </label>
