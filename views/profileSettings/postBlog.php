<main class="container">
            <div class="row">
                ...
                <div class="col-md-6 p-3">
                    <a class="btn bg-body-tertiary round background grow-button d-block" role="button" href="#"
                       target="_blank">
                        ...
                        <div class="text-content">
                            ...
                            <p class="lead responsiveText">Catégorie - <?php echo $mapView['blogDate'] ?> - Par <?php echo $mapView['blogAuthor'] ?></p>
