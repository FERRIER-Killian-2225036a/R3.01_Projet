    ...
    <div class="py-lg-5">
        ...
        <div id="buttonContainer" class="row">
            ...
            <div class="col-md-4 d-flex justify-content-center">
                ...
                <a href="forumFeed.php" type="button" class="w-20 rounded-4 btn btn-lg text-center colorButton shadow-gn disabled "><!-- "disabled" grow-button Pour l'instant jusqu'à ce que la page forum fonctionne dès que ça fonctionne virer le disabled-->
