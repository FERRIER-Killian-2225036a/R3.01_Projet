  ...
  <section class="py-5 text-left container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-left">
        ...
        <p class="lead text-body-secondary">Ici est le début de la page home avec juste une phrase qui finira par être modifier </p>
        <p>
          <div class="col-lg-8 col-md-8 mx-left">
            <a href="#" class="cta noneColor text-left block">
