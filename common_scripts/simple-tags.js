...
class Tags {
    ...
    constructor(selectElement, opts = {}) {
        ...
        this.allowNew = !!selectElement.dataset.allowNew;
        this.showAllSuggestions = !!selectElement.dataset.showAllSuggestions;
        this.badgeStyle = selectElement.dataset.badgeStyle || "primary";
        this.allowClear = !!selectElement.dataset.allowClear;
        this.server = selectElement.dataset.server || false;
        this.liveServer = !!selectElement.dataset.liveServer;
    ...
    isSelected(text) {
        ...
        return !!(opt && opt.getAttribute("selected"));
